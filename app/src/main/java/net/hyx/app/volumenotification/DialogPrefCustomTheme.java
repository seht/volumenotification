...
class DialogPrefCustomTheme extends DialogPreference {
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            preferences.edit().putString("pref_custom_theme_background_color", background_color_edit.getText().toString()).commit();
            preferences.edit().putString("pref_custom_theme_icon_color", icon_color_edit.getText().toString()).commit();
        }
    }
}
