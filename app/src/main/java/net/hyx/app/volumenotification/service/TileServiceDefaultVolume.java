...
public class TileServiceDefaultVolume extends TileService {
    ...
    public void onTileAdded() {
        super.onTileAdded();
        NotificationController.newInstance(getApplicationContext()).updateTile(getQsTile(), 8);
    }
    ...
    public void onClick() {
        super.onClick();
        NotificationController.newInstance(getApplicationContext()).audioManagerModel().setVolume(8);
    }
